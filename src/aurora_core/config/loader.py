...
_ENVIRONMENT_FIELDS: dict[
    ...
    ("hyperhdr", "controls", "enabled"): bool,
    ("hyperhdr", "controls", "allowed_operations"): tuple,
    ("hyperhdr", "controls", "timeout_seconds"): float,
    ("hyperhdr", "controls", "operation_limit"): int,
    ("hyperhdr", "controls", "operation_window_seconds"): int,
    ("wled", "enabled"): bool,
    ("wled", "host"): str,
    ("wled", "port"): int,
    ...
    ("ambient_controls", "enabled"): bool,
    ("ambient_controls", "allowed_operations"): tuple,
    ("ambient_controls", "operation_limit"): int,
    ("ambient_controls", "operation_window_seconds"): int,
    ("ddp", "enabled"): bool,
    ("ddp", "host"): str,
    ("ddp", "port"): int,
    ...
    ("dashboard", "bind_host"): str,
    ("dashboard", "port"): int,
    ("dashboard", "refresh_seconds"): int,
    ("dashboard", "cpu_temperature_warning_c"): float,
    ("dashboard", "memory_warning_percent"): float,
    ("dashboard", "storage_warning_percent"): float,
    ("dashboard", "authentication", "enabled"): bool,
    ("dashboard", "authentication", "username"): str,
    ("dashboard", "authentication", "password_hash"): str,
    ("dashboard", "authentication", "session_ttl_minutes"): int,
    ("dashboard", "authentication", "maximum_sessions"): int,
    ("dashboard", "authentication", "secure_cookie"): bool,
    ("dashboard", "authentication", "login_attempt_limit"): int,
    ("dashboard", "authentication", "login_attempt_window_seconds"): int,
    ("health_history", "enabled"): bool,
    ("health_history", "database_path"): str,
    ("health_history", "database_mode"): str,
    ("health_history", "sample_interval_seconds"): int,
    ("health_history", "retention_days"): int,
    ("mqtt", "enabled"): bool,
    ("mqtt", "host"): str,
    ("mqtt", "port"): int,
    ("mqtt", "username"): str,
